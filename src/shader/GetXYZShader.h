...
#ifndef ofxInkSimExample_GetXYZShader_h
#define ofxInkSimExample_GetXYZShader_h

#include "ofMain.h"
#include "InkShader.h"

class GetXYZShader : public InkShader
{
public:
    ...
    void glThree()
    {
        fragmentShader = GLSL150(
                                 ...
                                 void main(void)
                                 {
                                     ...
                                     fragColor = vec4(1.0 - a.x, 1.0 - a.y, 1.0 - a.z, 1.0);
                                 }
                                 );
